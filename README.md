...
This project is inspired by and based on [Nextflux](https://github.com/electh/nextflux) created by [@electh](https://github.com/electh). Special thanks to the original author and contributors for their work!
